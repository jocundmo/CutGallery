...
namespace Scanner
{
    ...
    public class PTImage
    {
        ...
        public static void CutForSquare(string postedFilePath, string fileSaveUrl, int side, int quality)
        {
            //创建目录
            ...
            System.Drawing.Image initImage = System.Drawing.Image.FromFile(postedFilePath);
        ...
        /// <param name="quality">质量（范围0-100）</param>
        public static void CutForCustom(string postedFilePath, string fileSaveUrl, int maxWidth, int maxHeight, int quality)
        {
        ...
        public static void ZoomAuto(string postedFilePath, string savePath, System.Double targetWidth, System.Double targetHeight, string watermarkText, string watermarkImage, out double resizeHeight, out double resizeWidth)
        {
            resizeHeight = -1;
            resizeWidth = -1;
            //创建目录
            ...
            using (FileStream fileStream = new FileStream(postedFilePath, FileMode.Open))
            {
                initImage = System.Drawing.Image.FromStream(fileStream);
            }
            //System.Drawing.Image initImage = System.Drawing.Image.FromFile(postedFilePath, true);
