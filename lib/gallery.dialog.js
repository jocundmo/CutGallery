...
(function($) {
   $.widget("ui.gallery_dialog",  {
     ...
     _layout: function() {
       $("#g-dialog").dialog('option', 'minHeight', 80); // CutGallery - Override the minHeight of dialog.
       var dialogWidth;
       var dialogHeight = $("#g-dialog").height();
       var cssWidth = new String($("#g-dialog form").css("width"));
//       var customizedWidth;
//       var customizedHeight;
//       
//       if ($("#g-dialog .cust")) {
//          customizedWidth = $("#g-dialog .cust").css("width");
//          customizedHeight = $("#g-dialog .cust").css("height");
//       }
...
//       
//       if (customizedWidth != undefined && customizedHeight != undefined) {
//           dialogWidth = customizedWidth;
//           alert(customizedWidth); alert(customizedHeight);
//           $("#g-dialog").dialog('option', 'height', customizedHeight);
//           
//       }
