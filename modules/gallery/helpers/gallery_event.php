...
class gallery_event_Core {
  ...
  static function add_album_menu($menu, $theme){
      $item = $theme->item();
      if (!empty($item)) {
  ...
  static function admin_menu($menu, $theme) {
     $menu
      ...
      ->append(Menu::factory("dialog")
              ->id("manage_home_pic")
              ->label(t("首页图片管理"))
              ->url(url::site("quick/form_manage_home_pic")))
      ->append(Menu::factory("dialog")
              ->id("manage_aboutus_pic")
              ->label(t("关于我们管理"))
              ->url(url::site("quick/form_manage_aboutus_pic")))
      ->append(Menu::factory("dialog")
              ->id("manage_contactus_pic")
              ->label(t("联系我们管理"))
              ->url(url::site("quick/form_manage_contactus_pic")))
//      ->append(Menu::factory("link")
//              ->id("manage_home_pic")
